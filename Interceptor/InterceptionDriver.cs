...
namespace Interceptor
{
    ...
    /// </summary>
    public static class InterceptionDriver // https://github.com/jasonpang/Interceptor
    {
        ...
        public static extern int GetHardwareId(IntPtr context, int device, IntPtr hardwareIdentifier, uint sizeOfString);
