...
namespace MultiDeviceKeybinds
{
    ...
    public interface IMacro
    {
        ...
        /// <param name="correctedKey">The key that was pressed, corrected for left/right for modifiers</param>
        ...
        bool Perform(KeybindDevice device, Keys key, Keys correctedKey, KeyState state, KeyState lastState, string guid, params object[] args);
    }
}